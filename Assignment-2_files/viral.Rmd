...
**Table 2. Confusion Matrix for the Logistic Model of Viral**
```{r echo=FALSE, warning= FALSE}
...
We decided to include a graph to see the advantages in accuracy of the probabilistic models over the Knn classification model. 


**Graph 1. KNN model for several K's vs the LPM and Logit Models**
```{r echo=FALSE, warning= FALSE}
