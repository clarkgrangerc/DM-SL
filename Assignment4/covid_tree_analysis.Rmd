...
>>>>>>> f4e92f808fe4dc5116ad347869dd677e8a41fe0f
...
rb=rmse(x_test$cases100k,yhat_test3)
...
Regarding to the predictive performance of the models, we got an out of sample RMSE of `r rrf` for the RF model and `r rf` for the BT. This values sugget that these models are reasonable tools for prediction even tough they do not outperform the result of the Negative Binomial model on cases per 100k. 
